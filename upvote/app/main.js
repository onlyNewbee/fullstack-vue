const submissionComponent = {
  template: `
    <div style="display: flex; width: 100%">
        ...
        <img class="image is-64x64" v-bind:src="submission.submissionImage" title="pictures">
        </figure>
            ...
            <div class="content">
                <p>
                    ...
                    <small class="is-size-7">
                        Submitted by:
                        <img class="image is-24x24" v-bind:src="submission.avatar" title="profile pictures">
                    </small>
                </p>
            </div>
        </div>
    ...
    methods: {
        upvote: function (submissionsId) {
          const submission = this.submissions.find(
            (submission) => submission.id === submissionsId
          );
          submission.votes++;
        },
      }
